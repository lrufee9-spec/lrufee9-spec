...
let systemState = {
  user: { name: 'Admin', robotName: 'Aura-X', credits: 12450.75, health: 100 },
  emails: [{
    id: 'e1',
...
app.post('/api/maps', async (req, res) => {
  ...
  try {
    ...
    console.error('Maps AI Error:', err)
...
app.post('/api/speak', async (req, res) => {
  ...
  try {
    ...
    console.error('Speak AI Error:', err)
